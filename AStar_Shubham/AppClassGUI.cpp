...
#pragma endregion
	...
	//About
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::TextColored(ImColor(255, 255, 255), "Press the arrow keys to move the creeper");
			ImGui::TextColored(ImColor(255, 255, 255), "Press C to change the visibility of the octree");
			ImGui::TextColored(ImColor(255, 255, 255), "Press 'Add' or 'Subtract keys to increse or decrease octree subdivisions'");
		}
		ImGui::End();
	}
